...
import com.jiaoyiyu.back.bean.TaskCollect;
...
/**
 * TaskCollectionController class
 *
 * @author maochaoying
 * @date 2019/11/11
 */
...
public class TaskCollectionController {
    ...
    public String index(HttpServletRequest request, ModelMap modelMap) {
        ...
        List<TaskCollect> taskCollectList = publishTaskService.getTaskCollectByMemberId(memberId);

        List<TaskCollectVO> taskCollectVOList = publishTaskService.transTaskCollectToVO(taskCollectList);

        modelMap.put("taskCollectVOList",taskCollectVOList);
