    ...
    var securityCode=randomNum(0,9)+''+randomNum(0,9)+''+randomNum(0,9)+''+randomNum(0,9);
    ...
    document.getElementById('auth-code').addEventListener('click',function () {
        securityCode=randomNum(0,9)+''+randomNum(0,9)+''+randomNum(0,9)+''+randomNum(0,9);
        options.txt=securityCode;
        writeAuthCode(options);
    })