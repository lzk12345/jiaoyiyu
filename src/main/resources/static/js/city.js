...
$(function() {
    ...
    var address=$("#address");
    var province=$(address).attr('province');
    var citys=$(address).attr('city');
    var county=$(address).attr('county');
    province =='false'?$("#province").remove():'';
    citys == 'false' ?$("#citys").remove():'';
    county== 'false' ?$("#county").remove():'';
});
// 省值变化时 处理市
